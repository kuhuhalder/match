        ...
        <Router>
          <Routes>
            ...
            <Route
              ...
              element={<ViewProfileMatches />}
            />
            <Route exact path="/viewrequests" element={<ViewRequests />} />
            <Route
              exact
              path="/viewstudybuddies"
              element={<ViewStudyBuddies />}
            />
            <Route
              exact
              path="/viewprofilerequests"
              element={<ViewProfileRequests />}
            />
            <Route
              exact
              path="/viewprofilestudybuddies"
              element={<ViewProfileStudyBuddies />}
            />
